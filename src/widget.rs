...
pub struct CameraWidget {
    pub widget_type: CameraWidgetType,
    pub label: [c_char; 256],
    pub info: [c_char; 1024],
    pub name: [c_char; 256],
    pub parent: *mut CameraWidget,
    pub value_string: *mut c_char,
    pub value_int: c_int,
    pub value_float: c_float,
    pub choice: *mut *mut c_char,
    pub choice_count: c_int,
    pub min: c_float,
    pub max: c_float,
    pub increment: c_float,
    pub children: *mut *mut CameraWidget,
    pub children_count: c_int,
    pub changed: c_int,
    pub readonly: c_int,
    pub ref_count: c_int,
    pub id: c_int,
    pub callback: CameraWidgetCallback,
}
